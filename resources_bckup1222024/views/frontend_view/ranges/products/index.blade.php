            ...
            @endif
               ...
               <?php if($range_data->isNotEmpty()) {
                  ...
                  <section class="zero_padding" id="product_banner">
                      <div class="row ">
                          <div class="col-md-12">
                              <img src="http://127.0.0.1:8000/assets/images/filter_finder/filter_finder_header.jpg" alt="Filter Finder Header1"/>
                              <div class="top-left">
                    ...
                    <div class="container">
                      <div class="row justify-content-center ">
                        ...
                        <div class="col-md-12 general-text-color">
                            @if($range_data->isNotEmpty())
                              @if ($range_data[0]->range_id=='2')
                                <p class="text-center mb-2 nsr22">Our Range of</p>
                                <h3 class="mb-4 text-center"><b>{{ $range_data[0]->prod_name; }}</b></h3>
                              @endif
                              ...
                              @endif
                                ...
                                @if ($range_data[0]->range_id=='1')
                                    @if ($range_data[0]->prod_id=='1')
                                      <h2 class="mb-4 text-center"><b>{{ $range_data[0]->prod_name; }}</b></h2>
                                    @endif
                                  @if($range_data[0]->prod_id!='5' && $range_data[0]->prod_id!='1')
                                  <h2 class="mb-4 {{ $colorclass;}}"><b>{{ $range_data[0]->prod_name; }}</b></h2>
                                      @if($prod_desc_data->isNotEmpty())
                                          <div class="mb-5 content_description">{!! $prod_desc_data[0]->pd_desc; !!}</div>
                                      @endif
                                  @endif
                                @endif
                            @endif
                                  ...
                                  ?>
                                    <div class="{{ $col }} ranges_prod">
                                      <a href="{{ URL($data->cat_url) }}">
                                        ...
                                        <div class="prod_name">
                                          <label class="text-uppercase" style="margin:20px 0 0;"><b>{!! $data->cat_name !!}</b></label></br>
