          ...
          <div class="megamenu_d">
              ...
              <div class="sidebar-bottom">
                <div class="sidebar_rel">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <a href="#" target="_blank"> <img src="https://www.johnsontestpapers.com/images/iso/iso9001.jpg" alt="Snow" style="width:100%"> </a>
                      </div>

                      <div class="col-md-6">
                        <a href="#" target="_blank"> <img src="https://www.johnsontestpapers.com/images/iso/iso13485.jpg" alt="Snow" style="width:100%"> </a>
                      </div>
                    </div>
                ...
                <div class="zeynep opened">
                    ...
                    <ul>
                      <li class="has-submenu">
                        <a href="#" data-submenu="productcategories">Product & Services</a>
            
                        <div id="productcategories" class="submenu">
                          <div class="submenu-header"> 
                            <a href="#" data-submenu-close="productcategories">Product & Services</a> </div>

                          <ul>
                              <li> <a href="{{ URL('product/rapid_test') }}">Rapid Test</a> </li>
                              <li> <a href="{{ URL('product/filtration') }}">Filtration</a> </li>
                              <li> <a href="{{ URL('product/pool_and_spa') }}">Pool & Spa</a> </li>
                              <li> <a href="{{ URL('product/aquarium') }}">Aquarium</a> </li>
                              <li> <a href="{{ URL('product/visual_test_kits') }}">Visual Test Kits</a> </li>
                              <li> <a href="{{ URL('product/industries') }}">Industries</a> </li>
                              <li> <a href="{{ URL('product/oem_label') }}">OEM Private Label</a> </li>
                            </ul>
                        </div>
                      </li>

                      <li class="has-submenu"><a href="#" data-submenu="company">Company</a>
                        <div id="company" class="submenu">
                          <div class="submenu-header">
                            <a href="#" data-submenu-close="company">Company</a>
                          </div>
                          <ul>
                            <li><a href="{{ url('company/about-us') }}">Our Story</a></li>
                            <li><a href="{{ url('company/imprint') }}">Imprint</a></li>
                      ...
                      <li class="has-submenu"><a href="#" data-submenu="support">Support</a>
                      <div id="support" class="submenu">
                          <div class="submenu-header">
                            <a href="#" data-submenu-close="support">Support</a>
                          </div>
                        <ul>
                          <li><a href="{{ url('support/contact-us') }}">Contact Us</a></li>
                          <li><a href="{{ url('support/document') }}">Document & Certificates</a></li>
