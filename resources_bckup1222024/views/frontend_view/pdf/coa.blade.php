...
<head>
    ...
    @font-face { 
        font-family: 'MyFont'; 
        src: url('{{url('/fonts/centurygothic.ttf')}}') 
        format('truetype') 
    } footer {
        padding-bottom: 1em;
        width:100%;
        ...
        <small style="float: right; font-size:0.5em;">DOC 025 ISS 4</small>
            <header style="margin-top:0.5em;">
                ...
                <div style="display:block; float:right;">
                    ...
                    <img class="logo" style="height:100px; width:100%;" src="{{ public_path().'/assets/images/colour-logo.png'}}" alt="JTP-Logo">
                </div>
            </header>
            ...
            <footer>
                ...
                <div style="position:relative; padding-left: 1em;">
                    {{-- Have to put the directory to the live..  --}}
                    <img class="iso13485" src="{{ public_path().'/assets/images/iso/iso13485.jpg'}}" style="width:8em;"  alt="iso13485">
                    <img class="iso9001" src="{{ public_path().'/assets/images/iso/iso9001.jpg'}}" style="width:8em;"  alt="iso9001">
                </div>
            </footer>
